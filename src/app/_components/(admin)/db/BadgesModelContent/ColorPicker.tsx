...
export function ColorPicker({ onChange, defaultValue }: Props) {
  const [background, setBackground] = useState(defaultValue ?? "#fff");
    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button
          variant={"outline"}
          className={cn(
            "justify-start w-[220px] text-left font-normal bg-black",
      ...
      <PopoverContent className="w-64">
        ...
        <input
          id="custom"
          value={background}
          className="col-span-2 h-8 mt-4 rounded border border-[#8b8b8bb3] bg-card px-3 py-1 outline-none"
